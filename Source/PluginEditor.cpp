...
std::array<juce::AudioParameterBool*, 3> SimpleMBCompAudioProcessorEditor::getBypassParams()
{
    ...
    auto* lowBypassParam = boolHelper(Params::Names::Bypassed_Low_Band);
    auto* midBypassParam = boolHelper(Params::Names::Bypassed_Mid_Band);
    auto* highBypassParam = boolHelper(Params::Names::Bypassed_High_Band);
